...
bcs = [
    [0, Constant((0.0, 0.0)), walls],  # No-slip BC
    [0, Constant((1.0, 0.0)), top_boundary],  # Velocity's x = 1 at top
    [1, Constant(0.0), top_boundary],  # Pressure out BC at top
    [2, Constant(15), left_boundary], # Temperature BC
    [2, Constant(0), right_boundary] # Temperature BC
]

problem = Problem(mesh, ics, bcs)
fluid = Fluid(1.0, 0.01, 0.598, 4184) # ⍴, μ, k, C_p
